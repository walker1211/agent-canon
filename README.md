...
Download the archive for your platform from the GitHub Release. Archives are named `agent-canon_vX.Y.Z_<goos>_<goarch>.tar.gz` and include the `agent-canon` binary, `LICENSE`, `README.md`, `README.zh-CN.md`, and `README.md`.
